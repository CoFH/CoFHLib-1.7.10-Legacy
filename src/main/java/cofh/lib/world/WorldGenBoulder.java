...
public class WorldGenBoulder extends WorldGenerator {
	...
	@Override
	public boolean generate(World world, Random rand, BlockPos posCenter) {

		//TODO cleanup and use BlockPos
		int xCenter = posCenter.getX();
		int yCenter = posCenter.getY();
		int zCenter = posCenter.getZ();
