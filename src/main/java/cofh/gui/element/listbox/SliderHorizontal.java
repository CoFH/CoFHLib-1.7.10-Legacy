...
public abstract class SliderHorizontal extends ElementBase {
	...
	public void drawForeground(int mouseX, int mouseY) {
		...
		int sliderWidth = 8;
		int sliderHeight = sizeY;
		int sliderX = posX + (sizeX - sliderWidth) * _value / _valueMax;
		int sliderY = posY;
	...
	public void update(int mouseX, int mouseY) {
		...
		if (_isDragging) {
			setValue(_valueMax * (mouseX - posX) / sizeX);
		}
	}
